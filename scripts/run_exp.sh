...
ht_g_ref=/scratch/groups/blangme2/jacob/vis_exp_chr9_NA19238/hisat_indexes/popcov10
...
#echo "ht2, C9_PG"
#time hisat2 -p 4 -x $ht_per_ref -U $fq -S $ht_per_sam
...
#echo "ht2, chr 9"
#time hisat2 -p 4 -x $ht_ref_9 -U $fq -S $ht_sam_9
#python -O $dir/scripts/analyze_sam.py -s 1 -g $g_sam -n $ht_sam_9

#echo "ht2, whole genome with snps (provided by ht2)"
#time hisat2 -p 4 -x $ht_ref_snp -U $fq -S $ht_sam
#python -O $dir/scripts/analyze_sam.py -s 1 -g $g_sam -n $ht_sam

# Graph
#echo "ht2, popcov chr9 genome"
#time hisat2 -p 4 -x $ht_g_ref -U $fq -S $ht_g_sam
