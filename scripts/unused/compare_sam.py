...
def check_var(dict_var, names, ref_index, main_index, alt_index, per):
...
def check_aln(target, dict_ref, dict_per, item='mapq'):
    ...
    if dict_ref != None:
        if 'mapq' in item:
            for i in list_target:
                target_on_ref.append(dict_ref[i].mapq)
            avg_mapq = float(sum(target_on_ref)) / len(target_on_ref)
            print ('  Avg mapq on ref', avg_mapq)
    if dict_per != None:
        if 'mapq' in item:
            for i in list_target:
                target_on_per.append(dict_per[i].mapq)
            avg_mapq = float(sum(target_on_per)) / len(target_on_per)
            print ('  Avg mapq on per', avg_mapq)
...
def compare_sam(args):
    ...
    ref_index, _ = build_index(var_list)
    ...
    # Reads aligned to standard ref genome
    dict_ref_c = {}
    dict_ref_ic = {}
    dict_ref_u = {}
    for line in ref_c_f:
    ...
    print ('  Looking dict_pc_rc...')
    check_aln(target=dict_pc_rc, dict_ref=dict_ref_c, dict_per=dict_per_c, item='mapq')
    ...
    print ('  Looking dict_pic_rc...')
    check_aln(target=dict_pic_rc, dict_ref=dict_ref_c, dict_per=dict_per_ic, item='mapq')
    ...
    print ('  Looking dict_pu_rc...')
    check_aln(target=dict_pu_rc, dict_ref=dict_ref_c, dict_per=None, item='mapq')
    ...
    print ('  Looking dict_pc_ric...')
    check_aln(target=dict_pc_ric, dict_ref=dict_ref_ic, dict_per=dict_per_c, item='mapq')
    ...
    print ('  Looking dict_pic_ric...')
    check_aln(target=dict_pic_ric, dict_ref=dict_ref_ic, dict_per=dict_per_ic, item='mapq')
    ...
    print ('  Looking dict_pu_ric...')
    check_aln(target=dict_pu_ric, dict_ref=dict_ref_ic, dict_per=None, item='mapq')
    ...
    print ('  Looking dict_pc_ru...')
    check_aln(target=dict_pc_ru, dict_ref=None, dict_per=dict_per_c, item='mapq')
    ...
    print ('  Looking dict_pic_ru...')
    check_aln(target=dict_pic_ru, dict_ref=None, dict_per=dict_per_ic, item='mapq')
