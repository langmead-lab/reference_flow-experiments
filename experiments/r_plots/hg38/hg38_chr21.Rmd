...
df_ref_real_pe <- read.delim("data/real/paired_end/wg-GRC-NA12878.allele.bias", header = TRUE, sep = "\t")
df_maj_real_pe <- read.delim("data/real/paired_end/wg-major-NA12878.allele.bias", header = TRUE, sep = "\t")
df_rf_real_pe <- read.delim("data/real/paired_end/wg-refflow-10-thrds0_S1_b1000_ld1-NA12878.allele.bias", header = TRUE, sep = "\t")
df_rf_real_pe_prev <- read.delim("data/real/paired_end/wg-refflow-10-thrds0_S1_b1000_ld1-NA12878-prev.allele.bias", header = TRUE, sep = "\t")
df_per_real_pe <- read.delim("data/real/paired_end/wg-per-NA12878.allele.bias", header = TRUE, sep = "\t")
# df_per_real_pe_prev <- read.delim("data/real/paired_end/wg-per-NA12878-prev.allele.bias", header = TRUE, sep = "\t")

df_ref_real_pe <- filter_df(df_ref_real_pe)
df_maj_real_pe <- filter_df(df_maj_real_pe)
df_rf_real_pe <- filter_df(df_rf_real_pe)
df_rf_real_pe_prev <- filter_df(df_rf_real_pe_prev)
df_per_real_pe <- filter_df(df_per_real_pe)
...
hist_targets_real <- c(hist_rf_real_pe, hist_maj_real_pe, hist_ref_real_pe, hist_per_real_pe)
hist_names_real <- c('RandFlow-LD_pe', 'Major_pe', 'GRC_pe', 'Personalized_pe')
# hist_targets_real <- c(hist_ref_real_pe, hist_maj_real_pe, hist_rf_real_pe, hist_rf_real_pe_prev, hist_per_real_pe)
# hist_names_real <- c('GRC_pe', 'Major_pe', 'RandFlow-LD_pe', 'RandFlow-LD_pe-prev', 'Personalized_pe')
# hist_targets_real <- c(hist_ref_real, hist_maj_real, hist_rf_real, hist_vg_real, hist_per_real, hist_ref_real_pe, hist_maj_real_pe, hist_rf_real_pe, hist_per_real_pe)
# hist_names_real <- c('GRC', 'Major', 'RandFlow-LD', 'vg', 'Personalized', 'GRC_pe', 'Major_pe', 'RandFlow-LD_pe', 'Personalized_pe')
