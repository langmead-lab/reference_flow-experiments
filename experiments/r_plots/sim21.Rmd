...
ggplot(df_var_all, aes(X, variable)) +
  ...
  # scale_fill_gradient2(high='red', low='blue', mid='yellow', midpoint=0.5, limits=(c(min(df_var_all$value),1))) +
  theme_bw() + labs(fill="Jaccard similarity", x="", y="") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
```
```{r test_var_scatter}
...
group_AFR <- c("21_superpop_AFR_thrds0.5_S0_b1_ld0", "21_superpop_AFR_thrds0_S1_b1_ld0", "21_superpop_AFR_thrds0_S1_b1000_ld1", "HG03028")
group_AMR <- c("21_superpop_AMR_thrds0.5_S0_b1_ld0", "21_superpop_AMR_thrds0_S1_b1_ld0", "21_superpop_AMR_thrds0_S1_b1000_ld1", "HG01072")
group_EUR <- c("21_superpop_EUR_thrds0.5_S0_b1_ld0", "21_superpop_EUR_thrds0_S1_b1_ld0", "21_superpop_EUR_thrds0_S1_b1000_ld1", "NA20528")
group_EAS <- c("21_superpop_EAS_thrds0.5_S0_b1_ld0", "21_superpop_EAS_thrds0_S1_b1_ld0", "21_superpop_EAS_thrds0_S1_b1000_ld1", "NA18631")
group_SAS <- c("21_superpop_SAS_thrds0.5_S0_b1_ld0", "21_superpop_SAS_thrds0_S1_b1_ld0", "21_superpop_SAS_thrds0_S1_b1000_ld1", "HG02660")
